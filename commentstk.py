...
def display_comments(post_id, username):
    ...
    frame = Frame(master=comment_window, borderwidth=5, height=50, relief="flat")
    ...
    if len(comments)==0:
        print(" New post - No comments")
        comment_text_label = ctk.CTkLabel(master=scrollbar, text="No comments yet, be the first to comment", font=("Ink Free", 14, "bold"), wraplength=400, justify="left")
        comment_text_label.pack(padx=0, pady=10, anchor="w")
        ...
        comment_text_entry = Text(master=frame, width=50, height=5, font=("Ink Free", 14, "bold"))
        ...
        # Submit button
        submit_button = tk.Button(master=frame, text="Add Comment", font=("Ink Free", 14, "bold"), command=submit_comment)
        submit_button.pack()
    else:
        for comment in comments:
            cmnt = comment[2]+" :  "+comment[3]
            #print(cmnt)
            comment_text_label = ctk.CTkLabel(master=scrollbar, text=cmnt, font=("Ink Free", 14, "bold"), wraplength=400, justify="left")
        ...
        # Submit button
        submit_button = tk.Button(master=frame, text="Add Comment", font=("Ink Free", 14, "bold"), relief="flat", command=submit_comment, background='#7a7a7a')
